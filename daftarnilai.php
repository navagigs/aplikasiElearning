...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser']) AND $_SESSION['login']==0){
 ...
 echo "<div> <a href='index.php'><img src='images/kunci.png'  height=176 width=143></a>
  ...
  echo "<input type=button class=simplebtn value='LOGIN DI SINI' onclick=location.href='index.php'></a></center>";
        ...
        if (!empty($cek_mapel)){
            echo"<div id='back'>	  
	  			<ul class='back'><a href='?module=home'><img src='assets/images/icn_alert_error.png' /></a></ul>
				<br><article class='module width_full'><header><h3><b class='judul'>Lihat Nilai</b></h3></header>
            	<table id='table'>
            ...
            while ($t=mysql_fetch_array($mapel)){
                echo "<tr>
                        ...
                        echo"<td><input type=button class='tombol' title='Lihat Nilai' value='Lihat Nilai'
