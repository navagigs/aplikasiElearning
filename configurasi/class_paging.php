...
if($halaman_aktif > 1){
	...
	$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=daftarmateri&id=$_GET[id]&halaman=1><< First</a> |
                    <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=daftarmateri&id=$_GET[id]&halaman=$prev>< Prev</a> | ";
}
else{ 
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=daftarmateri&id=$_GET[id]&halaman=$i>$i</a> | ";
  }
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... | <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=daftarmateri&id=$_GET[id]&halaman=$jmlhalaman>$jmlhalaman</a> | " : " ");
...
if($halaman_aktif < $jmlhalaman){
	...
	$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=daftarmateri&id=$_GET[id]&halaman=$next>Next ></a> |
                     <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=daftarmateri&id=$_GET[id]&halaman=$jmlhalaman>Last >></a> ";
}
else{
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=lihatmurid&id=$_GET[id]&halaman=1><< First</a> |
                    <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=lihatmurid&id=$_GET[id]&halaman=$prev>< Prev</a> | ";
}
else{
	$link_halaman .= "<< First | < Prev | ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=lihatmurid&id=$_GET[id]&halaman=$i>$i</a> | ";
  }
	  $angka .= " <b>$halaman_aktif</b> | ";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... | <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=lihatmurid&id=$_GET[id]&halaman=$jmlhalaman>$jmlhalaman</a> | " : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=lihatmurid&id=$_GET[id]&halaman=$next>Next ></a> |
                     <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=lihatmurid&id=$_GET[id]&halaman=$jmlhalaman>Last >></a> ";
}
else{
	$link_halaman .= " Next > | Last >>";
}
